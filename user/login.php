...
if(isset($_POST['login'])) 
  {
    ...
    $sql = "SELECT studentid, id, eocourse FROM tbleventorganizer WHERE (username=:stuid || studentid=:stuid) and Password=:password";
...
$_SESSION['sturecmsstuid']=$result->studentid;
$_SESSION['sturecmsuid']=$result->ID;
$_SESSION['stuclass']=$result->eocourse;
}
...
<html lang="en">
  <head>
    ...
    <title>AchieveX|| Event Organizer Login Page</title>
    <!-- plugins:css -->
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <img src="images/logo.svg"> AchieveX
                </div>
