...
<html>
<head>
<title>AchieveX || Home Page</title>
...
<div class="slider">
       <div class="callbacks_container">
        <ul class="rslides" id="slider">
         <li>     
          <h3>AchieveX</h3>      
           <p>Registered Event Organizer can Login Here</p>             
          <div class="readmore">
          <a href="user/login.php">Event Organizer Login<i class="glyphicon glyphicon-menu-right"> </i></a>
          </div>
         </li>
